...
const EmployeesModal: React.FC<Props> = ({
  isOpen,
  closeModal,
  process,
  deleteId,
  ...
  const handleSubmit = async (values: Values) => {
    ...
    if (parsedValues.ProfileImage) {
      formData.append("Image", parsedValues.ProfileImage);
    }
    ...
    formData.append("HasCompany", parsedValues.HasCompany);
