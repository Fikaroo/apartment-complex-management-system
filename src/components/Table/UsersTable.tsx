        ...
        <tbody>
          {data?.data?.map((item: any) => (
            ...
            >
              ...
              <td
                className="w-20 h-20 px-6 py-4 text-sm font-medium leading-5 text-right whitespace-no-wrap border-b border-gray-200"
              ...
              >
                <img
                  ...
                  className="absolute z-50 w-20 h-20 ml-4 cursor-pointer"
                  src="/icons/edit.svg"
                />
              </td>
            </tr>
